...
public class Main {
    ...
    private static void trySplitFix(Subject subject, boolean purify) throws IOException, Exception {
        ...
        stringBuffer.append("start : ").append(simpleFormat.format(new Date())).append("\n");
        System.out.println(stringBuffer.toString());
        JavaFile.writeStringToFile(logFile, stringBuffer.toString(), false);
...
//			MFLocalization sbfLocator = new MFLocalization(subject);
            ...
            sbfLocator.setPassedTesdCases(new OchiaiResult(subject).getPassedTestCases());
    ...
    private static void flexibelConfigure(String projName, Set<Integer> ids, Map<String, Pair<Integer, Set<Integer>>> projInfo) throws IOException, Exception {
